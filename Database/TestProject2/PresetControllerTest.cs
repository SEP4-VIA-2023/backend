...
public class PresetsControllerTests
{
    ...
    public async Task UpdatePreset_ExistingPresetId_ReturnsOkResult()
    {
        ...
        // Assert.AreEqual("Preset updated successfully", (result as OkObjectResult)?.Value);

        // Verify that the preset was updated in the database
        ...
        // Assert.IsFalse(updatedPreset.isActive);
    }
